...
| `SeaSprint 1.0.0-55-1-0-0-1778784735.zip` | Pak bundle | 1 | None | 0 / 0 | `Subnautica2\Content\Paks\~mods` |
...
- `SeaSprint`: `.pak`, `.ucas`, and `.utoc` companions are grouped as one pak bundle.
...
- Current release behavior: non-blocked managed plans can apply through Apply Preview, while loose overlays remain blocked and recovery only touches manifest-tracked managed files.
